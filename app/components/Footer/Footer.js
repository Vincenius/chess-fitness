...
const Footer = () => {
  return <footer className={styles.footer}>
    ...
    <Typography variant="subtitle1" color="text.secondary" align="center">
      We're still in beta. If you encounter any issues feel free to report them via <a href="mailto:info@wweb.dev">Email</a> or <a href="https://github.com/Vincenius/chess-fitness">GitHub</a>.
    </Typography>
  </footer>
}
